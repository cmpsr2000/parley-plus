...
const dialogue_container: PackedScene = preload('res://addons/parley/components/dialogue/dialogue_container.tscn')
const dialogue_options_container: PackedScene = preload('res://addons/parley/components/dialogue_option/dialogue_options_container.tscn')
const next_dialogue_button: PackedScene = preload('res://addons/parley/components/next_dialogue_button.tscn')
